...
viagendif = read.csv2("Bancos/banco_comparacao_medias.csv")
...
for (i in 1:length(mapsp@data$ds_codigo)){
  ...
  ides = c(intersect(oriaux$`coordsor$ID`, viagendif$ID))
  aux = viagendif[viagendif$ID %in% c(ides),]
  aux=aux[is.na(aux$ID)==FALSE,]
  soma = sum(aux$tempodif)
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_diferenca_tempo_regioes_SPTrans", driver = "ESRI Shapefile",overwrite_layer = TRUE)
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_diferenca_tempo_distritos", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_diferenca_tempo_areas_de_ponderacao", driver = "ESRI Shapefile", overwrite_layer = TRUE)
