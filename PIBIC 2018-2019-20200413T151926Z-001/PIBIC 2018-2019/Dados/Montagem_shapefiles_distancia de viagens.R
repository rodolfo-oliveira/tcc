...
comparacaomedias = read.csv2("Bancos/banco_comparacao_medias.csv")
...
for (i in 1:length(mapsp@data$ds_codigo)){
  ...
  ides = c(intersect(oriaux$`coordsor$ID`, comparacaomedias$ID))
  aux = comparacaomedias[comparacaomedias$ID %in% c(ides),]
  aux=aux[aux$temppublico+aux$temppriv > 20,]
  aux=aux[is.na(aux$ID)==FALSE,]
  soma = sum(aux$distpublico+aux$distpriv)/2
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_Distancia_media", driver = "ESRI Shapefile", overwrite_layer = TRUE)
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_distancia_media_distritos", driver = "ESRI Shapefile")
...
writeOGR(new_map,dsn = "/home/rodolfo/Documentos/Programação/PIBIC 2018-2019/Dados/Geo/", layer="mapa_Origem_distancia_media_areas_de_ponderacao", driver = "ESRI Shapefile")
