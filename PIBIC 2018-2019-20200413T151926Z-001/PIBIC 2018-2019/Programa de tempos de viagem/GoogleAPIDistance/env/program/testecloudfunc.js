 ...
 */
exports.startInstancePubSub2 = (event, callback) => {
  try {
    ...
    compute
      ...
      .then(() => {
        ...
        const message = 'Successfully started instance ' + payload.instance1;
        console.log(message);
    ...
    try {
      ...
      compute
        ...
        .then(() => {
          // Operation complete. Instance successfully started.
          const message = 'Successfully started instance ' + payload.instance2;
          console.log(message);
          callback(null, message);
        })
        .catch(err => {
      ...
      compute
        ...
        .then(() => {
          // Operation complete. Instance successfully started.
          const message = 'Successfully started instance ' + payload.instance3;
          console.log(message);
          callback(null, message);
        })
        .catch(err => {
